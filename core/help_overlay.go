...
func (h *helpOverlay) Draw(screen *ebiten.Image, kb views.KeyBindingsInterface, isRemote bool) {
	...
	entries = append(entries,
		...
		helpEntry{"", ""},
		helpEntry{"Tech Progression", ""},
		helpEntry{"Electronics", "Drives tech growth (buy or produce)"},
		helpEntry{"Tech 0.5", "Refinery (Oil -> Fuel)"},
		helpEntry{"Tech 1.0", "Factory + Shipyard"},
		helpEntry{"Tech 2.0", "Fusion Reactor + Cruiser"},
		helpEntry{"Tech 2.5", "Research Lab (passive Electronics)"},
	)
